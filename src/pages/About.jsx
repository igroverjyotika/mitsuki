  ...
  return (
    <div className="bg-white dark:bg-gray-950 overflow-hidden">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-blue-900 dark:via-indigo-900 dark:to-purple-900 py-24 md:py-32 overflow-hidden">
        {/* More animated background elements with higher opacity */}
        <div className="absolute inset-0 opacity-20">
          ...
          <div className="absolute top-20 left-1/3 w-20 h-20">
            <img
              src={product3}
              alt=""
          ...
          <div className="absolute top-32 right-1/4 w-28 h-28">
            <img
              src={product4}
              alt=""
              className="w-full h-full object-contain animate-float"
          ...
          {/* Middle row */}
          <div className="absolute top-1/2 left-20 w-26 h-26">
            <img
              src={product1}
              alt=""
              className="w-full h-full object-contain animate-spin-slow"
          ...
          <div className="absolute top-1/2 right-16 w-24 h-24">
            <img
              src={product2}
              alt=""
              className="w-full h-full object-contain animate-float"
          ...
          <div className="absolute bottom-32 left-1/3 w-22 h-22">
            <img
              src={product1}
              alt=""
              className="w-full h-full object-contain animate-spin-slow"
          ...
          <div className="absolute bottom-24 right-1/4 w-24 h-24">
            <img
              src={product2}
              alt=""
              className="w-full h-full object-contain animate-float"
          ...
          <div className="absolute top-2/3 right-1/3 w-26 h-26">
            <img
              src={product4}
              alt=""
              className="w-full h-full object-contain animate-float"
